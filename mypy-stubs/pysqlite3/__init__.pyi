...
if sys.version_info < (3, 14):
    from .dbapi2 import version_info as version_info
...
if sys.version_info < (3, 12):
    from .dbapi2 import enable_shared_cache as enable_shared_cache, version as version

if sys.version_info < (3, 10):
    from .dbapi2 import OptimizedUnicode as OptimizedUnicode
...
_RowFactoryOptions: TypeAlias = (
    type[Row] | Callable[[Cursor, tuple[Any, ...]], object] | None
)
...
class Connection:
    ...
    def create_collation(
        self, name: str, callback: Callable[[str, str], SupportsIndex] | None, /
    ) -> None: ...
    def create_function(
        self,
        name: str,
